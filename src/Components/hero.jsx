...
const navigation = [
  // { name: 'Product', href: '#' },
  // { name: 'Features', href: '#' },
  // { name: 'Marketplace', href: 'http://localhost:5173/marketplace' },
  // { name: 'Company', href: '#' },
]
  ...
  return (
    <div className="bg-gray-900">
      ...
      <div className="relative isolate px-6 pt-24 lg:px-8">
        <img src="https://www.apple.com/v/home/cm/images/heroes/iphone-17/hero_iphone_17__c5vvimu9a20y_large_2x.jpg"  className="absolute inset-0 h-full w-full object-cover object-center -z-20" />
        <div
          aria-hidden="true"
